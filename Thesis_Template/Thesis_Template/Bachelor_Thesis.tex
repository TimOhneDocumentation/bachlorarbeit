...
\usepackage{csquotes}
\usepackage{listings}
\usepackage[style=alphabetic, backend=biber, backref, firstinits=true, maxbibnames=40,maxalphanames=1]{biblatex} % Include the biblatex package
...
\pagenumbering{Roman} 						% roman numbers for abstract and toc
