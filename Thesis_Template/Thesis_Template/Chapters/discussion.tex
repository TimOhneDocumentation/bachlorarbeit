...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Runs_170_400_Gain_62.0_0_ChannelALL_FPGAS.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Individual_Stddev_and_Mean_vs_Gain.png}
